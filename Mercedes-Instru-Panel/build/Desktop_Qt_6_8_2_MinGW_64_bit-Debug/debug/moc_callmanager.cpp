...
static constexpr auto qt_meta_stringdata_ZN11CallManagerE = QtMocHelpers::stringData(
    "CallManager",
    "callStarted",
    "",
    "contactName",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11CallManagerE[] = {
...
Q_CONSTINIT const QMetaObject CallManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11CallManagerE.offsetsAndSizes,
    qt_meta_data_ZN11CallManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11CallManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void CallManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->startCall((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (CallManager::*)(const QString & );
            if (_q_method_type _q_method = &CallManager::callStarted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *CallManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11CallManagerE.stringdata0))
...
// SIGNAL 0
void CallManager::callStarted(const QString & _t1)
{
