...
static constexpr auto qt_meta_stringdata_ZN15VoiceControllerE = QtMocHelpers::stringData(
    "VoiceController"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15VoiceControllerE[] = {
...
Q_CONSTINIT const QMetaObject VoiceController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15VoiceControllerE.offsetsAndSizes,
    qt_meta_data_ZN15VoiceControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15VoiceControllerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<VoiceController, std::true_type>
    >,
    nullptr
} };
...
void *VoiceController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15VoiceControllerE.stringdata0))
