...
namespace {
struct qt_meta_tag_ZN15AudioControllerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15AudioControllerE = QtMocHelpers::stringData(
    "AudioController",
    "volumeLevelChanged",
    "",
    "volumeLevel",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15AudioControllerE[] = {
...
Q_CONSTINIT const QMetaObject AudioController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15AudioControllerE.offsetsAndSizes,
    qt_meta_data_ZN15AudioControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15AudioControllerE_t,
...
void AudioController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->volumeLevelChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AudioController::*)(int );
            if (_q_method_type _q_method = &AudioController::volumeLevelChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AudioController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15AudioControllerE.stringdata0))
